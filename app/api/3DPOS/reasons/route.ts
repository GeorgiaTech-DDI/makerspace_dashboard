...
function categorizeReason(reason: string): string {
  ...
  if (cleanReason.includes("Other Academic Course"))
    return "Other Academic Course";
  if (cleanReason.includes("Project for Club/Lab/Other Org"))
    return "Club/Lab/Org Project";
  if (cleanReason.includes("Training/Studio Improvement"))
    return "Training/Studio Improvement";
